...
var njdotcomContest = '<a href="http://www.nj.com/entertainment/index.ssf/2016/02/' +
                      ...
                      '<a href="http://connect.nj.com/user/Brian%20Donohue/posts.html" ' +
                      'target="_blank"><strong>Brian Donohue</strong></a> on ' +
                      '<a href="http://www.nj.com/ target="_blank">NJ.com</a>';

var original = 'Designed based on feedback from the <a href="http://www.nj.com/entertainment/index.ssf/2016/02/' +
                      'vote_for_a_new_flag_for_new_jersey.html" target="_blank">' +
