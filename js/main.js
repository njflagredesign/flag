var flagList = [
  { designer: "Andrew Maris",
    ...
    "uniform. The militia wore a blue coat over a red waistcoat, often accompanied " + 
    "by a white sash. Three colors and star represent the third state to join " + 
    "the union and the first to ratify the Bill of Rights."
  },
  ...
  { designer: "Marmocet",
    ...
    "blue are used on N.J.'s current flag. The shade of red was taken from the " + 
    "cuffs and collars of NJ revolutionary war uniforms."
  },
    { designer: "Alan Hall",
    location:"Ontario, Canada",
    image: "images/flag-5.jpg", 
    description:"The borders between the buff and blue are cut to resemble an " + 
    "outline of the state. The torch is a simplified version of the one held by " + 
    "the Statue of Liberty. The three flames signify New Jersey's place as the third state."
  },
  { designer: "Andrew Zega",
    location:"Paris",
    image: "images/flag-6.jpg", 
    description:"The band of buff represents the golden fields of the Garden State. " + 
    "The blue is the sky and the seven-pointed white sun recalls the crown of the " + 
    "Statue of Liberty"
  },
  ...
  { designer: "Kenneth Huang",
    ...
    "Revolutionary War N.J. flag reportedly just had the three plows and a horse's head on it."
  },
...
function ViewModel(){
  ...
  self.updateModal = function( flag ){
